...
#include <perspective/arrow_single_threaded_reader.h>
...
namespace apachearrow {
    ...
    csvToTable(std::string& csv, bool is_update, std::unordered_map<std::string, std::shared_ptr<arrow::DataType>>& schema) {
        ...
        convert_options.timestamp_parsers = std::vector<std::shared_ptr<arrow::TimestampParser>>{
